        ...
        <div className="donate-cards">
          ...
          <div className="donate-card">
            ...
            <div className="donate-amounts">
              ...
              <button className="donate-submit-btn"><i className="fas fa-dollar-sign" style={{marginRight: "5px"}}></i>Donate Now</button>
          </div>
          ...
          <div className="donate-card">
            ...
            <div className="donate-amounts">
              ...
              <button className="donate-submit-btn"><i className="fas fa-dollar-sign" style={{marginRight: "5px"}}></i>Subscribe Monthly</button>
          </div>
        </div>
      </div>
